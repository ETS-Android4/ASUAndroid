...
public class RibbonAdapter9 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ArrayList<RibbonItem> RibbonAdapter9(ArrayList<RibbonItem> mRibbonList) {
        return mRibbonList;
    }
    public interface OnItemClickListener { void onEditRibbonClick(int ribbon, int position);}
    public void setOnItemClickListener(RibbonAdapter9.OnItemClickListener listener) { mListener = listener; }

    public static class Ribbon9Holder extends RecyclerView.ViewHolder {

        public Ribbon9Holder(View itemView, OnItemClickListener listener, ArraySet<ImageView> images, ArrayList<List<ImageView>> oaks) {
            super(itemView);
            ...
            RibbonAdapter9.mImageView1.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            RibbonAdapter9.mImageView2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView6.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView7.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView8.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter9.mImageView9.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public RibbonAdapter9(ArrayList<RibbonItem> ribbonList) {
        mRibbonList = ribbonList;
    }
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RibbonAdapter9.Ribbon9Holder) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int ViewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ribbon_item9, parent, false);
        return new RibbonAdapter9.Ribbon9Holder(view, mListener, images, oaks);
    }
