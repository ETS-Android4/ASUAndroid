...
public class RibbonAdapter19 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ArrayList<RibbonItem> RibbonAdapter19(ArrayList<RibbonItem> mRibbonList) {
        return mRibbonList;
    }
    public interface OnItemClickListener { void onEditRibbonClick(int ribbon, int position);}
    public void setOnItemClickListener(RibbonAdapter19.OnItemClickListener listener) { mListener = listener; }

    public static class Ribbon19Holder extends RecyclerView.ViewHolder {

        public Ribbon19Holder(View itemView, OnItemClickListener listener, ArraySet<ImageView> images, ArrayList<List<ImageView>> oaks) {
            super(itemView);
            ...
            RibbonAdapter19.mImageView1.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            RibbonAdapter19.mImageView2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView6.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView7.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView8.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView9.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView10.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView11.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView12.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView13.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView14.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView15.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView16.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView17.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView18.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter19.mImageView19.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public RibbonAdapter19(ArrayList<RibbonItem> ribbonList) {
        mRibbonList = ribbonList;
    }
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RibbonAdapter19.Ribbon19Holder) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int ViewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ribbon_item19, parent, false);
        return new RibbonAdapter19.Ribbon19Holder(view, mListener, images, oaks);
    }
