...
public class RibbonAdapter8 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ArrayList<RibbonItem> RibbonAdapter8(ArrayList<RibbonItem> mRibbonList) {
        return mRibbonList;
    }
    public interface OnItemClickListener { void onEditRibbonClick(int ribbon, int position);}
    public void setOnItemClickListener(RibbonAdapter8.OnItemClickListener listener) { mListener = listener; }

    public static class Ribbon8Holder extends RecyclerView.ViewHolder {

        public Ribbon8Holder(View itemView, OnItemClickListener listener, ArraySet<ImageView> images, ArrayList<List<ImageView>> oaks) {
            super(itemView);
            ...
            RibbonAdapter8.mImageView1.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            RibbonAdapter8.mImageView2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView6.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView7.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter8.mImageView8.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public RibbonAdapter8(ArrayList<RibbonItem> ribbonList) {
        mRibbonList = ribbonList;
    }
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RibbonAdapter8.Ribbon8Holder) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int ViewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ribbon_item8, parent, false);
        return new RibbonAdapter8.Ribbon8Holder(view, mListener, images, oaks);
    }
