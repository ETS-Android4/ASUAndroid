...
public class RibbonAdapter5 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ArrayList<RibbonItem> RibbonAdapter5(ArrayList<RibbonItem> mRibbonList) {
        return mRibbonList;
    }
    public interface OnItemClickListener { void onEditRibbonClick(int ribbon, int position);}
    public void setOnItemClickListener(RibbonAdapter5.OnItemClickListener listener) { mListener = listener; }

    public static class Ribbon5Holder extends RecyclerView.ViewHolder {

        public Ribbon5Holder(View itemView, OnItemClickListener listener, ArraySet<ImageView> images, ArrayList<List<ImageView>> oaks) {
            super(itemView);
            ...
            RibbonAdapter5.mImageView1.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            RibbonAdapter5.mImageView2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter5.mImageView3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter5.mImageView4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            RibbonAdapter5.mImageView5.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
    ...
    public RibbonAdapter5(ArrayList<RibbonItem> ribbonList) {
        mRibbonList = ribbonList;
    }
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RibbonAdapter5.Ribbon5Holder) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int ViewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ribbon_item5, parent, false);
        return new RibbonAdapter5.Ribbon5Holder(view, mListener, images, oaks);
    }
