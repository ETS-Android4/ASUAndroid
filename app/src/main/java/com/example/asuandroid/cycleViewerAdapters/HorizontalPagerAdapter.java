...
import static com.example.asuandroid.screens.UniformPresentationFragment.context;
...
public class HorizontalPagerAdapter extends PagerAdapter {
    public static ArrayList<Drawable> fromRibbonBuilds = UniformPresentationFragment.bitmapDrawableArray;
    ...
    public void createLibrary() {
        ...
        if(tatters > 0) {
            ...
            new Utils.LibraryObject(fromRibbonBuilds.get(0), "");
        }
