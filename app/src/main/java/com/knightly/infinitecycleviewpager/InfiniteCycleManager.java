...
import static com.knightly.infinitecycleviewpager.InfiniteCyclePagerAdapter.OnNotifyDataSetChangedListener;
...
class InfiniteCycleManager implements OnNotifyDataSetChangedListener {
    ...
    private com.knightly.infinitecycleviewpager.InfiniteCyclePagerAdapter mInfiniteCyclePagerAdapter;
    ...
    public com.knightly.infinitecycleviewpager.InfiniteCyclePagerAdapter getInfiniteCyclePagerAdapter() {
    ...
    public PagerAdapter setAdapter(final PagerAdapter adapter) {
        ...
        if (adapter != null && adapter.getCount() >= MIN_CYCLE_COUNT) {
            ...
            mInfiniteCyclePagerAdapter = new com.knightly.infinitecycleviewpager.InfiniteCyclePagerAdapter(adapter);
