package com.knightly.infinitecycleviewpager;
...
import com.knightly.infinitecycleviewpager.OnInfiniteCyclePageTransformListener;
import com.knightly.infinitecycleviewpager.VerticalViewPager;
...
public class VerticalInfiniteCycleViewPager extends VerticalViewPager implements ViewPageable {
    ...
    private com.knightly.infinitecycleviewpager.InfiniteCycleManager mInfiniteCycleManager;
    ...
    private void init(final Context context, final AttributeSet attributeSet) {
        mInfiniteCycleManager = new com.knightly.infinitecycleviewpager.InfiniteCycleManager(context, this, attributeSet);
    }
    ...
    protected void setChildrenDrawingOrderEnabled(final boolean enabled) {
        super.setChildrenDrawingOrderEnabled(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_DISABLE_FLAG);
    }

    @Override
    public void setClipChildren(final boolean clipChildren) {
        super.setClipChildren(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_DISABLE_FLAG);
    }

    @Override
    public void setDrawingCacheEnabled(final boolean enabled) {
        super.setDrawingCacheEnabled(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_DISABLE_FLAG);
    }

    @Override
    protected void setChildrenDrawingCacheEnabled(final boolean enabled) {
        super.setChildrenDrawingCacheEnabled(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_DISABLE_FLAG);
    }

    @Override
    public void setWillNotCacheDrawing(final boolean willNotCacheDrawing) {
        super.setWillNotCacheDrawing(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_ENABLE_FLAG);
    }

    @Override
    public void setPageMargin(final int marginPixels) {
        super.setPageMargin(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_PAGE_MARGIN);
    }

    @Override
    public void setOffscreenPageLimit(final int limit) {
        super.setOffscreenPageLimit(com.knightly.infinitecycleviewpager.InfiniteCycleManager.DEFAULT_OFFSCREEN_PAGE_LIMIT);
    }
